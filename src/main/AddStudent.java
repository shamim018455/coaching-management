...
public class AddStudent extends javax.swing.JPanel {
    ...
    private void initComponents() {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(tBatch)
                            .addComponent(tGroup, 0, 740, Short.MAX_VALUE)
        ...
        saveStudent.setBackground(new java.awt.Color(153, 204, 255));
        ...
        jLabel10.setText("\"Save Students\"");
    ...
    private void saveStudentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveStudentActionPerformed
        getStudentValue();
        writeinTarea();
        if (tId.getSelectedIndex() < 0 && !vName.isEmpty() && !vAddress.isEmpty() && !vClass.isEmpty() && !vBatch.isEmpty() && !vContact.isEmpty() && !vDate.isEmpty() && (tMale.isSelected() || tFemale.isSelected())) {
            DataController.addStudent(vId, vName, vGender, vAddress, vGroup, vClass, vBatch, vContact, vDate);
